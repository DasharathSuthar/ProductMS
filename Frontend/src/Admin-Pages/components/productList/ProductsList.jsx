        ...
        <>  <ToastContainer position="top-right" autoClose={3000} />
            ...
            <div className='p-1 mb-2 flex justify-between items-center'>
                ...
                <div className='flex flex-wrap  gap-1 items-center'>
                    ...
                    {isEdit && (
                        <button className='py-2 px-5 ml-2  bg-green-500 rounded-md text-white uppercase hover:bg-green-700 duration-300' onClick={updateProductDetails} >Update</button>
                    )}
                    {isImageEdit && (
                        <button className='py-2 px-5 ml-2  bg-green-500 rounded-md text-white uppercase hover:bg-green-700 duration-300' onClick={updateImage} >Update Image</button>
                    )}
                </div>
            </div>
